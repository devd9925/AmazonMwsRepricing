...
use devd9925\AmazonMwsRepricing\Models\AwsSqsConfigInterface;
use devd9925\AmazonMwsRepricing\Models\PriceChangeMessage;
...
class AwsSqsService
{
    ...
    public function getPriceUpdates($queueUrl,$messageCount=false)
    {
        ...
        $dataProcessor = new \devd9925\AmazonMwsRepricing\Processors\PriceChangeDataProcessor();
        $items = array();
